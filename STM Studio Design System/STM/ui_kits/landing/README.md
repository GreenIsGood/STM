...
Top-right switch: **Desktop / Mobile / Direction B**, plus an **EN ⇄ ع** toggle
that re-renders the desktop and mobile screens in Arabic RTL. The mobile
hamburger opens a real menu. Work cards and every CTA link out to the real
Instagram posts and WhatsApp thread from the source.
